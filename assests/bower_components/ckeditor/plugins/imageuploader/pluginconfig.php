...
$username = "admin"; $password = '21232f297a57a5a743894a0e4a801fc3';
    ...
    $useruploadfolder = "erp/assets/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "erp/assets/ckeditor/plugins/imageuploader/uploads";
        

    $useruploadfolder = "erp/assets/images/noticeupload";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "erp/assets/images/noticeupload";
