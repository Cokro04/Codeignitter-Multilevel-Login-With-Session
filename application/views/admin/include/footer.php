  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2008-2019 <a target="_blank" href="https://infinityglobalmedia.com">INFINITY GLOBAL MEDIA</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- ChartJS -->
<script src="<?php echo  base_url('assests/');?>bower_components/chart.js/Chart.js"></script>
